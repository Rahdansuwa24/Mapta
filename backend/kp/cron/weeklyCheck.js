...
async function scheduler() {
    try{
        const [rows] = await db.query(`select id_peserta_magang, nama, tanggal_mulai_magang, tanggal_selesai_magang, status_penerimaan from peserta_magang where status_penerimaan = 'Diterima'`)
...
cron.schedule("0 0 0 * * 0", scheduler);
